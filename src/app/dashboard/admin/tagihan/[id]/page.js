    ...
    <>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white rounded-3xl md:rounded-[2.5rem] w-full max-w-xl p-6 md:p-8 shadow-2xl animate-in fade-in zoom-in duration-300 relative overflow-hidden max-h-[95vh] ">
            ...
            <form onSubmit={handleSubmitPembayaran} className="space-y-4 md:space-y-6 overflow-y-auto pr-1 custom-scrollbar">
              <div className="bg-slate-50 p-4 md:p-6 rounded-2xl md:rounded-[2rem] border border-slate-100 space-y-3 md:space-y-4">
                ...
                <div className="space-y-3 max-h-24 md:max-h-28 overflow-y-auto pr-2 custom-scrollbar font-bold text-slate-600 text-sm md:text-base">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="space-y-2">
                  ...
                  <textarea
                    className="w-full bg-slate-50 border border-slate-200 p-3 md:p-4 text-sm md:text-base font-bold text-slate-900 outline-none focus:border-primary rounded-xl md:rounded-2xl h-20 md:h-24 resize-none"
                ...
                <div className="flex flex-col-reverse sm:flex-row gap-3 md:gap-4">
                  <button
                    ...
                    className="w-full sm:flex-1 py-3 md:py-4 bg-slate-100 text-slate-700 font-bold rounded-xl md:rounded-2xl hover:bg-slate-200 transition-all text-sm md:text-base"
                  >
                    Batal
                  </button>
                  <button
                    ...
                    className="w-full sm:flex-[2] bg-primary text-white py-3 md:py-4 rounded-xl md:rounded-2xl font-black text-base md:text-lg shadow-xl shadow-primary/20 hover:bg-primary-hover transition-all flex items-center justify-center gap-3"
                  >
