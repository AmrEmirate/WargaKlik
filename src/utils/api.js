    ...
    if (error.response?.status === 401 && !originalRequest._retry && originalRequest.url !== '/auth/login' && originalRequest.url !== '/auth/refresh') {
      ...
      try {
        ...
        if (res.data.success) {
          ...
          // FIX: Secure cookie flags to prevent CSRF
          Cookies.set('token', accessToken, { expires: 1/24, sameSite: 'strict', secure: isProd });
          Cookies.set('refreshToken', newRefreshToken, { expires: 7, sameSite: 'strict', secure: isProd });
